# The purpose of this sample / example PTR Response script is to post data from PTR to sentinel
...
# Disclaimer: Please note that this is a sample example script and is not officially supported by Proofpoint.
